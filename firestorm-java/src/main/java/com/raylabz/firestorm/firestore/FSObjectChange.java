...
public class FSObjectChange<T> {
     ...
     */
    public FSObjectChange(T object, QueryDocumentSnapshot document, int oldIndex, int newIndex, Type type) {
        this.object = object;
     ...
     * @return Returns an {@link FSObjectChange.Type}
     */
    public Type getType() {
        return type;
    }
