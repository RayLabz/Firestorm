...
class FSExistDelegate {
  ...
  Future<bool> one<T>(dynamic object, { String? subcollection }) async {
    ...
    DocumentReference ref = FS.firestore.collection(object.runtimeType.toString()).doc(object.id);
    if (subcollection != null) {
      ref = FS.firestore.collection(object.runtimeType.toString()).doc(subcollection).collection(subcollection).doc(object.id);
    }
