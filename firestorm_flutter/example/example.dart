...
main() async {
  ...
  // Example usage of Firestorm (in a real app, you would typically do this in a service or widget class):
  Person person = Person("id-1", "John", "Doe", 23);

  FS.create.one(person).then((_) {
    //TODO - Proceed with your app logic...
  },)
  .onError((error, stackTrace) {
    //TODO - Show alert dialog or log error...
  },);
